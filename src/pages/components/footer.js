    ...
    <>
      <View style={windowWidth >= 380 ? styles.footer : styles.footer2}>
        ...
        >
          ...
          <Text
            style={windowWidth >= 380 ? styles.Newsletter : styles.Newsletter2}
          >
            News
          </Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          style={windowWidth >= 380 ? styles.fcam : styles.fcam2}
          activeOpacity={0.4}
          onPress={handleNavigateToCamera}
        >
          <Entypo
            style={windowWidth >= 380 ? styles.cam : styles.cam2}
            name="camera"
            size={35}
            color="white"
          />
      ...
      <View style={styles.textfooter}></View>
    </>
  );
};
